...
public class LightTest {
	...
	public void directionalLightTest() {
		...
		geometries.add(new Sphere(new Color(50, 100, 0), new Material(0.5, 0.5, 100), 150, new Point3D(0, 0, 200)));
	...
	public void pointLightTest() {
		...
		geometries.add(new Sphere(new Color(89, 32, 77), new Material(0.7, 0.3, 100), 150, new Point3D(0, 0, -200)));
	...
	public void TrianglesPointLightTest() {
		...
		Geometries geometries = new Geometries();
		scene.setGeometries(geometries);
		geometries.add(new Triangle(new Material(0.5, 0.5, 300), new Color(0, 0, 0), new Point3D(-250, 250, 90),
				new Point3D(-250, -250, 120), new Point3D(250, 250, 90)));
		geometries.add(new Triangle(new Material(0.5, 0.5, 300), new Color(0, 0, 0), new Point3D(248, 248, 90),
	...
	public void spotLightTest() {
		...
		Geometries geometries = new Geometries();
		scene.setGeometries(geometries);
		geometries.add(new Sphere(new Color(0, 0, 255), new Material(0.5, 0.5, 100), 150, new Point3D(0, 0, -200)));

		List<LightSource> lights = new ArrayList<LightSource>();
		lights.add(new SpotLight(new Color(255, 255, 255), new Point3D(200, 200, -100), new Vector(-1, -1, -1), 1,
				0.001, 0.000001));
		scene.setLights(lights);
	...
	public void TrianglesSpotLightTest() {
		...
		Geometries geometries = new Geometries();
		scene.setGeometries(geometries);
		geometries.add(new Triangle(new Material(0.5, 0.4, 70), new Color(255, 0, 0), new Point3D(0, -200, -200),
				new Point3D(0, 0, -200), new Point3D(200, 0, -100)));
		geometries.add(new Triangle(new Material(0.5, 0.4, 70), new Color(0, 0, 255), new Point3D(0, -200, -200),
				new Point3D(0, 0, -200), new Point3D(-200, 0, -100)));
...
//ShadowTest 
	...
	public void shadowTest1() {
		...
		Geometries geometries = new Geometries();
		geometries.add(new Sphere(new Color(50, 100, 0), new Material(0.5, 0.5, 70), 150, new Point3D(0, 0, -200)));
		geometries.add(new Triangle(new Material(0.5, 0.5, 70), new Color(255, 0, 0), new Point3D(100, 100, -50),
				new Point3D(25, 100, -50), new Point3D(100, 25, -50)));
		scene.setGeometries(geometries);
	...
	public void shadowTest2() {
		...
		Geometries geometries = new Geometries();
		geometries.add(new Sphere(new Color(50, 100, 0), new Material(0.5, 0.5, 70), 150, new Point3D(0, 0, -200)));
		geometries.add(new Triangle(new Material(0.5, 0.5, 70), new Color(255, 0, 0), new Point3D(125, 125, -50),
				new Point3D(50, 125, -50), new Point3D(125, 50, -50)));
		scene.setGeometries(geometries);
	...
	public void shadowTest3() {
		...
		Geometries geometries = new Geometries();
		geometries.add(new Sphere(new Color(50, 100, 0), new Material(0.5, 0.5, 70), 150, new Point3D(0, 0, -300)));
		geometries.add(new Triangle(new Material(0.5, 0.5, 70), new Color(255, 0, 0), new Point3D(150, 150, -100),
				new Point3D(75, 150, -100), new Point3D(150, 75, -100)));
		scene.setGeometries(geometries);

		List<LightSource> lights = new ArrayList<LightSource>();
		lights.add(new SpotLight(new Color(255, 255, 255), new Point3D(170, 170, -20), new Vector(-1, 0, -1), 1, 0.0001,
				0.000001));
		scene.setLights(lights);
